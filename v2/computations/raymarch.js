...
//import { addListener, clearListeners } from './init.js';
...
export function startRaymarchingRenderLoop(gl, program, raymarchActive) {
...
export function setupRaymarchControls(gl, program) {
    ...
    function sendUniforms(time) {
        ...
        gl.uniform1f(uR1, r_0);
        gl.uniform1f(uR2, r_1);
